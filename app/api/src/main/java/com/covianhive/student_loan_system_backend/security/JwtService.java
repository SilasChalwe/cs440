...
public class JwtService {
    ...
    public JwtService(
        ...
        if (secret == null || secret.length() < 32 || secret.contains("change-this-secret")) {
            throw new IllegalStateException("app.jwt.secret must be a strong value with at least 32 characters.");
        }
